...
* a simple SQLite database for storing counts
...
* SQLite is simple and good for testing or small projects
* for bigger production use, PostgreSQL or Redis can be a better choice
...
* your backend database is writable
